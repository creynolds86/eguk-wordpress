<?php
/**
 * _egukbasetheme theme init setup
 *
...
if ( ! function_exists( '_egukbasetheme_setup' ) ) :
/**
 ...
 */
function _egukbasetheme_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on _egukbasetheme, use a find and replace
	 * to change '_egukbasetheme' to the name of your theme in all the template files
	 */
	load_theme_textdomain( '_egukbasetheme', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( '_egukbasetheme_custom_background_args', array(
...
endif; // _egukbasetheme_setup

add_action( 'after_setup_theme', '_egukbasetheme_setup' );
